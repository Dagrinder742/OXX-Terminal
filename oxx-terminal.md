...
* [x] **Onyx Ticker Board (Live Watchlist)**: Integrated a high-performance, 24-pair market hub that tracks live prices and 24h % changes across Majors, L1s, and DeFi assets, featuring a dedicated `USDC-USDT` macro liquidity anchor.
