...
# URL ENDPOINTS FOR DEMO AND LIVE TRADING
# [https://external-api.demo.kalshi.co](https://external-api.demo.kalshi.co)), 
# we'll want to make sure your production client switches the base URL to:
# [https://external-api.kalshi.com](https://external-api.kalshi.com)
...
# The above signature is generated by signing a concatenation of the timestamp, the HTTP method 
# and the path.

# Important: When signing requests, use the path without query parameters. For example, if your 
# request is to /trade-api/v2/portfolio/orders?limit=5, sign only /trade-api/v2/portfolio/orders 
